import { InlineIcon } from '@st/src/components/inlineIcon';
...
- [[Package] Components](https://github.com/Zilero232/wp-storybook-gutenberg/issues) - Open Issue Wordpress Gutenberg Repoimport { InlineIcon } from '@st/src/components/inlineIcon'
  import { Meta } from '@storybook/blocks'
